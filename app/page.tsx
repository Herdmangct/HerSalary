          ...
          >
            <div className="w-1/2">
              ...
              <p className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal">
                Let our cutting edge AI generate transcripts personalised to
                your situation.
              </p>
            </div>
            <div className="w-1/2">
              ...
              <p className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal">
                Sharpen your skills with our AI interviewer. <br />
                You'll be prepared for anything your boss has to say.
              </p>
            </div>
          </motion.div>
          ...
          <div className="flex gap-[15px] mt-8 md:mt-0">
            ...
            >
              ...
              >
                ...
                Original repo credit @Tameyer41
              </Link>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 40 }}
