...
export default function DemoPage() {
  ...
  useEffect(() => {
    ...
    // Get the first line, or default to an empty string if the array is empty
            ...
            <div className="h-full w-full items-center flex flex-col mt-[10vh]">
              {recordingPermission ? (
                <div className="w-full flex flex-col max-w-[1080px] mx-auto justify-center">
                  ...
                  <br />
                  <h2 className="text-l font-semibold text-left text-[#1D2B3A] mb-2">
                    Your Lines!
                  </h2>
                  <div>{ firstLine }</div>
                </div>
